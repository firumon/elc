<template>
  <q-page class="q-gutter-y-sm q-py-sm">
    ...
    <VoterCard :part="misc.part" :serial="misc.serial" class="q-mx-auto q-my-md" />
    <VoterRelations :voter="voter" />
    <AddPhone :voter="voter" />
...
import VoterCard from "components/list/VoterCard.vue";
import AddPhone from "components/list/AddPhone.vue";
